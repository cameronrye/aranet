...
| 6 | Integrations | <Badge text="DONE" variant="success" /> | Prometheus metrics, MQTT publisher |
...
<CardGrid>
  ...
  <Card title="Service Control" icon="setting">
    CLI commands for service install/start/stop management
  </Card>
  <Card title="Configuration API" icon="document">
